						...
						<table summary="이름, 아이디, 비밀번호, 비밀번호 확인, 이메일, 이메일수신여부, 주소, 휴대폰, 유선전화, 생년월일 순으로 회원가입 정보를 등록할수 있습니다." class="memberWrite" border="1" cellspacing="0">
							...
							<tbody>
								<tr>
									...
									<td><input type="text" name="name" id="joinName" class="w134" /></td>
								</tr>
								<tr>
									...
									<td>
										<ul class="pta">
											...
											<li class="r10"><input type="text"  name="id" id="joinId" class="w134" /></li>
											<li><a onclick="checkIdBtn()" class="nbtnMini">중복확인</a></li>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											<li class="r10"><input type="password"  name="pw" id="joinPw" class="w134" /></li>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											<li class="r10"><input type="text"  name="phone" id="joinPhone" class="w134" /></li>
										</ul>
									</td>
								</tr>
								<tr>
								<tr>
									<th scope="row"><span>birth</span></th>
									<td>
										<ul class="pta">
											<li class="r10"><input type="datetime-local"  name="bday" id="bday" class="w134" /></li>
										</ul>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											<li class="r10">
												 <label><input type="checkbox" name="hobby" value="swim">수영</label>
      											 &nbsp;&nbsp;		
											     ...
											     &nbsp;&nbsp;		
      											 <label><input type="checkbox" name="hobby" value="yoga">요가</label>
											     &nbsp;&nbsp;		
