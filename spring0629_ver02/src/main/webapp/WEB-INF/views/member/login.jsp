				...
				<div id="member">
					...
					<div class="informbox">
						...
						<form action="/member/login" method="post" name="loginfrm">
							<ul>
								<li><input type="text" name="id" id="loginId" class="loginType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='loginType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
								<li><input type="password" name="pw" id="loginPw" class="passType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='passType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
							</ul>
