...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function joinBtn1(){
				var ag1 = $("input[name='f_agree']:checked").val();
				var ag2 = $("input[name='s_agree']:checked").val();
				var ag3 = $("input[name='t_agree']:checked").val();
				if( ag1 =='agree' && ag2 =='agree' && ag3 =='agree' ){
					alert('가입성공');
					$("#agree01").val("agree");
					//location.href = "/member/join02?agree="+"true";
					agree.submit();
				}else{
					alert('필수 항목 모두 동의하셔야 가입이 가능합니다.');
				}
			}
...
<%@ include file="../layout/sub_top.jsp" %>
		...
		<section>
			<form name="agree" method="post" action="/member/join02">
				<input type="hidden" name = "join01" id = "agree01">
				...
				<div id="terms_button">
					...
					<input type="button" onclick="joinBtn1()" value="가입하기" />
				</div>
