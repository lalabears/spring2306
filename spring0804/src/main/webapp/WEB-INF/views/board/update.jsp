...
<body>
  ...
  <section>
    ...
    <form action="/board/update" name="noticeupdateFrm" method="post" enctype="multipart/form-data">
    <input type="hidden" name="nbno" value="${nbdto.nbno }" />
      <table>
        <colgroup>
          <col width="15%">
          <col width="85%">
        ...
        <tr>
          <th>제목</th>
          <td>
            <input type="text" name="nbtitle" value="${nbdto.nbtitle }">
          </td>
        </tr>
        <tr>
          <th>내용</th>
          <td>
            <textarea name="nbcontent" cols="50" rows="10" >
            ${nbdto.nbcontent }
            </textarea>
          </td>
        </tr>
        <tr>
          <th>이미지 표시</th>
          <td><img src="/upload/${nbdto.nbfile }">
          	${nbdto.nbfile } <br>
