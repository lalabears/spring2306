		...
		<div id="maxcontents">
			...
			<div class="brandList">
				<ul>
					...
					<li>
						<a href="#">
							<div class="img"><img src="/upload/${ cdto.bfile}" alt="제품이미지" /></div>
							<div class="name">${cdto.btitle }<br/>${cdto.id }</div>
							<div class="price"><fmt:formatDate value="${cdto.bdate}" pattern="yyyy-MM-dd"/>
</div>
						</a>
					</li>
					</c:forEach>
