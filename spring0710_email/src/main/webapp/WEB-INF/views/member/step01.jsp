						...
						<table summary="이름, 아이디, 비밀번호, 비밀번호 확인, 이메일, 이메일수신여부, 주소, 휴대폰, 유선전화, 생년월일 순으로 회원가입 정보를 등록할수 있습니다." class="memberWrite" border="1" cellspacing="0">
							...
							<tbody>	
								<tr>
									...
									<td>
										<ul class="pta">
											<li class="r10"><input type="text" name="name" id="mem_name" class="w134" /></li>
											<li class="pt5"><span class="mvalign">한글만 사용가능</span></li>
										</ul>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											<li class="r10"><input type="text"  name="email" id="mem_email"  class="w134" /></li>
											<li><a onclick="emailBtn()" style="cursor: pointer;" class="nbtnMini">인증코드 발송</a></li>
											<li class="pt5"><span class="mvalign">입력하신 이메일로 인증코드가 발송됩니다. 인증 코드를 입력해주세요 </span></li>
										</ul>
									</td>
								</tr>
								<tr>
									...
									<td>
										<ul class="pta">
											<li class="r10"><input type="password"  name="pw" id="mem_pw" class="w134" /></li>
											<li><span class="mvalign">※ 이메일을 확인해서 인증번호를 입력해주세요.</span></li>
										</ul>
									</td>
								</tr>
					...
					<div class="btnArea">
						<div class="bCenter">
							<ul>
								...
								<li><a style="cursor: pointer;" onclick="memberBtn()" class="sbtnMini">인증완료</a></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
